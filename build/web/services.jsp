                ...
                <div class="row text-center justify-content-center">
                    <div class="col-md-4 col-12">
                        <div class="img_box_two">
                            <div class="img_container" style="background-image: url('assets/img/bg/bl.jpg')" ></div>
                            <div class="content">
                                <h5 class="title">
                                    Consulation
                                </h5>
                    ...
                    <div class="col-md-4 col-12">
                        <div class="img_box_two">
                            <div class="img_container" style="background-image: url('assets/img/bg/bl2.jpg')" ></div>
                            <div class="content">
                                <h5 class="title">
                                    Great Solutions
